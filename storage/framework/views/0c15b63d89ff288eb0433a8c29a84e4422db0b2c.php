...
<head>
    ...
    <title><?php echo e(__('messages.t_toast_something_went_wrong')); ?></title>
            ...
            <main class="sm:flex">
                ...
                <div class="sm:ml-6">
                    ...
                    <div class="mt-10 flex space-x-3 sm:border-l sm:border-transparent sm:pl-6">
                        <a href="<?php echo e(url('/')); ?>" class="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-primary-600 hover:bg-primary-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-600">
                            <?php echo app('translator')->get('messages.t_back_to_homepage'); ?>    
                        </a>
                        <a href="<?php echo e(url('help/contact')); ?>" class="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md text-primary-700 bg-indigo-100 hover:bg-indigo-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-600">
...
<?php /**PATH D:\rizwan\riverr-13nulled\riverr-13nulled\codecanyon-39634853-riverr-freelance-services-marketplace\resources\views/errors/404.blade.php ENDPATH**/ ?>