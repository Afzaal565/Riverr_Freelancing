<div x-data="{ open: false }" class="relative inline-block">
    ...
    <button x-on:click="open = !open" type="button" class="hidden md:flex items-center text-gray-500 hover:text-primary-600 transition-colors duration-300 py-2 px-4 focus:outline-none focus:ring-0 dark:text-gray-100 dark:hover:text-white">
        ...
        <span class="ltr:ml-1 rtl:mr-1"><?php echo e($default_language_name); ?></span>
    </button>
            ...
            <?php $__currentLoopData = supported_languages(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lang): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div <?php if($default_language_code !== $lang->language_code): ?> wire:click="setLocale('<?php echo e($lang->language_code); ?>')" <?php endif; ?> class="py-2 px-4 rounded-sm inline-flex items-center cursor-pointer justify-between <?php echo e($default_language_code === $lang->language_code ? 'bg-primary-100/25 text-primary-600' : 'hover:bg-gray-50 dark:hover:bg-zinc-600'); ?> focus:outline-none w-full">
                    <div class="inline-flex items-center">
                        ...
                        <span class="font-medium text-xs dark:text-gray-200"><?php echo e($lang->name); ?></span>
                    </div>
...
</div><?php /**PATH D:\rizwan\riverr-13nulled\riverr-13nulled\codecanyon-39634853-riverr-freelance-services-marketplace\resources\views/livewire/main/partials/languages.blade.php ENDPATH**/ ?>