        ...
        <div class="col-span-12 lg:col-span-8">
            <div class="bg-white shadow rounded-lg mb-6">
                ...
                <div class="w-full mb-8 px-6 pb-8">
                    ...
                    <code class="block text-xs text-[#BFC7D5] bg-[#292D3E] px-4 leading-6 py-3 mb-6"><span class="text-amber-500">* * * * *</span> cd <span class="text-white"><?php echo e(base_path()); ?></span> && <span class="text-white"><?php echo e($pathToPhp); ?></span> artisan <span class="text-amber-500">schedule:run</span> >> /dev/null 2>&1</code>

                    
                    <code class="block text-xs text-[#BFC7D5] bg-[#292D3E] px-4 leading-6 py-3"><span class="text-amber-500">* * * * *</span> cd <span class="text-white"><?php echo e(base_path()); ?></span> && <span class="text-white"><?php echo e($pathToPhp); ?></span> artisan <span class="text-amber-500">queue:work --stop-when-empty</span> >> /dev/null 2>&1</code>
...
<?php /**PATH D:\rizwan\riverr-13nulled\riverr-13nulled\codecanyon-39634853-riverr-freelance-services-marketplace\resources\views/livewire/installation/crontab.blade.php ENDPATH**/ ?>