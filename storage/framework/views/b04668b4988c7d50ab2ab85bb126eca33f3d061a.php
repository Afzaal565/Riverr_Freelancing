                        ...
                        <li>
                            <div class="relative pb-8">
                                ...
                                <div class="relative flex space-x-3">
                                    ...
                                    <div class="min-w-0 flex-1 pt-1.5 flex justify-between space-x-4">
                                        <div>
                                            <p class="text-sm text-gray-500">upload_max_filesize <span class="font-medium text-gray-900"><?php echo e($upload_max_filesize); ?></span></p>
                                        </div>
                        ...
                        <li>
                            <div class="relative pb-8">
                                ...
                                <div class="relative flex space-x-3">
                                    ...
                                    <div class="min-w-0 flex-1 pt-1.5 flex justify-between space-x-4">
                                        <div>
                                            <p class="text-sm text-gray-500">post_max_size <span class="font-medium text-gray-900"><?php echo e($post_max_size); ?></span></p>
                                        </div>
                                        <div class="text-right text-sm whitespace-nowrap text-gray-500">
                                            <time datetime="2020-09-22">As large as the maximum file you will be uploading</time>
                                        </div>
                        ...
                        <li>
                            <div class="relative pb-8">
                                ...
                                <div class="relative flex space-x-3">
                                    ...
                                    <div class="min-w-0 flex-1 pt-1.5 flex justify-between space-x-4">
                                        <div>
                                            <p class="text-sm text-gray-500">memory_limit <span class="font-medium text-gray-900"><?php echo e($memory_limit); ?></span></p>
                                        </div>
                                        <div class="text-right text-sm whitespace-nowrap text-gray-500">
                                            <time datetime="2020-09-22">As large as the maximum file you will be uploading</time>
                                        </div>
                        ...
                        <li>
                            <div class="relative pb-8">
                                ...
                                <div class="relative flex space-x-3">
                                    ...
                                    <div class="min-w-0 flex-1 pt-1.5 flex justify-between space-x-4">
                                        <div>
                                            <p class="text-sm text-gray-500">max_execution_time <span class="font-medium text-gray-900"><?php echo e($max_execution_time); ?></span> (in seconds)</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <li>
                            <div class="relative pb-10">
                                <div class="relative flex space-x-3">
                                    ...
                                    <div class="min-w-0 flex-1 pt-1.5 flex justify-between space-x-4">
                                        <div>
                                            <p class="text-sm text-gray-500">max_input_time <span class="font-medium text-gray-900"><?php echo e($max_input_time); ?></span> (in seconds)</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<?php /**PATH D:\rizwan\riverr-13nulled\riverr-13nulled\codecanyon-39634853-riverr-freelance-services-marketplace\resources\views/livewire/installation/requirements.blade.php ENDPATH**/ ?>