    ...
    <div class="fixed inset-0 z-10 overflow-y-auto p-4 sm:p-6 md:p-20" role="dialog" aria-modal="true"  @keydown.window.escape="close()" x-show="isOpen" x-transition:enter="ease-out duration-300" x-transition:enter-start="opacity-0" x-transition:enter-end="opacity-100" x-transition:leave="ease-in duration-200" x-transition:leave-start="opacity-100" x-transition:leave-end="opacity-0">
        ...
        >
            ...
            <div class="relative">
                ...
                <input wire:model.debounce.500ms="q" wire:keydown.enter="enter" x-ref="search" type="text" class="h-12 w-full border-0 bg-transparent ltr:pl-11 ltr:pr-3 rtl:pr-11 rtl:pl-3 text-gray-800 placeholder-gray-400 focus:ring-0 sm:text-sm pt-2.5" placeholder="<?php echo e(__('messages.t_what_service_are_u_looking_for_today')); ?>">
...
<?php $__env->stopPush(); ?><?php /**PATH D:\rizwan\riverr-13nulled\riverr-13nulled\codecanyon-39634853-riverr-freelance-services-marketplace\resources\views/livewire/main/partials/search.blade.php ENDPATH**/ ?>