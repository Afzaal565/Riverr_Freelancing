            ...
            <div class="bg-white shadow rounded-lg mb-6">
                ...
                <div class="w-full mb-8 px-10 pb-8">
                    <ul role="list" class="list-disc space-y-6 text-[13px] font-medium text-gray-500">
                        <li class="leading-6">
                            Riverr is available only on CodeCanyon, if you buy it or download it from another websites it's either a spam or an edited version that may contains malwares. We always recommend you to <a href="<?php echo e($purchase_link); ?>" target="_blank" class="text-primary-600">buy riverr</a> from CodeCanyon to get regulary updates and fast support.
                        </li>
                        <li class="leading-6">
                            We typically respond any message within seconds, minutes or maximum hours, you can contact us on <a href="<?php echo e($purchase_link); ?>" target="_blank" class="text-primary-600">Codecanyon</a>, email <a href="mailto:MrEdwardHendrix@gmail.com" target="_blank" class="text-primary-600">MrEdwardHendrix@gmail.com</a> or directly using <a href="https://wa.me/<?php echo e($phone); ?>" target="_blank" class="text-primary-600">WhatsApp</a> for fast support.
                        </li>
                        <li class="leading-6">
...
<?php endif; ?>
<?php $component->withAttributes(['label' => 'Your purchase code','placeholder' => 'Random Value','model' => 'purchase_code','icon' => 'key']); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['label' => 'Your CodeCanyon username','placeholder' => 'Random Value','model' => 'username','icon' => 'account']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginala0274761f86638d78e36787c771a294b67c238db)): ?>
<?php $component = $__componentOriginala0274761f86638d78e36787c771a294b67c238db; ?>
...
<?php /**PATH D:\rizwan\riverr-13nulled\riverr-13nulled\codecanyon-39634853-riverr-freelance-services-marketplace\resources\views/livewire/installation/start.blade.php ENDPATH**/ ?>